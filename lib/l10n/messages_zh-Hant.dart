...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardFromKal" : MessageLookupByLibrary.simpleMessage("來自一個隨機挑選的對象"),
    "exampleCardIntroKal" : MessageLookupByLibrary.simpleMessage("歡迎來到 Kalium。當您收到或發送 BANANO 時，它將顯示如下："),
    ...
    "logoutDetailKal" : MessageLookupByLibrary.simpleMessage("刪除您在本裝置中的種子代碼和所有和 Kalium 相關的資料。如果您的種子代碼沒有備份，您將永遠無法存取您的帳戶"),
    ...
    "newAccountIntroKal" : MessageLookupByLibrary.simpleMessage("這是您的新帳戶。當您收到 BANANO 時，交易將顯示如下："),
    ...
    "scanInstructionsKal" : MessageLookupByLibrary.simpleMessage("掃描 Banano 二維條碼地址"),
    ...
    "shareKalium" : MessageLookupByLibrary.simpleMessage("分享 Kalium"),
    "shareKaliumText" : MessageLookupByLibrary.simpleMessage("試試 Kalium —— Banano 的官方移動裝置錢包！"),
    ...
    "transferCompleteKal" : MessageLookupByLibrary.simpleMessage("%1 BANANO 順利移轉到您的 Kalium 錢包。\n"),
    "transferConfirmInfoKal" : MessageLookupByLibrary.simpleMessage("檢測到一個內有 %1 BANANO 的錢包。\n"),
    ...
    "transferIntroKal" : MessageLookupByLibrary.simpleMessage("這過程會將紙錢包的資產轉移到您的 Kalium 錢包。\n\n請輕觸 \"%1\" 按鈕開始。"),
    ...
    "transferNoFundsKal" : MessageLookupByLibrary.simpleMessage("這個種子不含任何 BANANO"),
    "transferQrScanError" : MessageLookupByLibrary.simpleMessage("這個二維條碼不含任何有效的種子"),
    "transferQrScanHintKal" : MessageLookupByLibrary.simpleMessage("掃描 Banano 種子"),
    "unlock" : MessageLookupByLibrary.simpleMessage("解鎖"),
    "unlockBiometricsKal" : MessageLookupByLibrary.simpleMessage("透過生物辨識來解鎖 Kalium"),
    "unlockPinKal" : MessageLookupByLibrary.simpleMessage("請輸入識別碼以解鎖 Kalium"),
    "viewDetails" : MessageLookupByLibrary.simpleMessage("更多資訊"),
    "warning" : MessageLookupByLibrary.simpleMessage("警告"),
    "welcomeTextKal" : MessageLookupByLibrary.simpleMessage("歡迎來到 Kalium。接著您可建立新錢包或匯入現有錢包"),
