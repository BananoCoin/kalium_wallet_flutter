...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "transferHeader" : MessageLookupByLibrary.simpleMessage("ПеречислитьnСредства:"),
    "transferIntro" : MessageLookupByLibrary.simpleMessage("Этот процесс переведёт средства с бумажного кошелька на ваш Kalium кошелёк.nnНажмите кнопку\"%1\"чтобы начать."),
    ...
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("Сканировать Banano nseed или закрытый ключ"),
