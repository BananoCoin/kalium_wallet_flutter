...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "biometricsMethod" : MessageLookupByLibrary.simpleMessage("Dấu vân tay"),
    ...
    "pinCreateTitle" : MessageLookupByLibrary.simpleMessage("Tạo mã gồm 4 chữ số"),
    ...
    "repInfo" : MessageLookupByLibrary.simpleMessage("Đại diện là một tài khoản bỏ phiếu cho sự đồng thuận trên nền tảng Internet . Quyền biểu quyết được cân bằng theo số dư, bạn có thể ủy quyền số dư của mình để tăng số biểu quyết của đại diện mà bạn tin cậy.\n    Người đại diện của bạn không có quyền sử dụng số tiền của bạn. Bạn nên chọn một đại diện có nhiều thời gian cho bạn và đáng tin cậy."),
    "repInfoHeader" : MessageLookupByLibrary.simpleMessage("Đại diện là gì?"),
    "scanInstructions" : MessageLookupByLibrary.simpleMessage("Quét 1 Banano \nđịa chỉ mã QR"),
    ...
    "transferHeader" : MessageLookupByLibrary.simpleMessage("Chuyển\nFunds:"),
    "transferIntro" : MessageLookupByLibrary.simpleMessage("Quá trình này sẽ chuyển từ quỹ ví giấy sang ví Kalium của bạn.\n\nNhấn vào \"%1\" Nút để bắt đầu."),
    ...
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("Quét một Banano \nseed hoặc private key"),
