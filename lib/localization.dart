...
class AppLocalization {
  ...
  String get transferIntroKal {
    return Intl.message(
        "This process will transfer the funds from a paper wallet to your Kalium wallet.\n\nTap the \"%1\" button to start.",
        desc: 'transfer_intro',
        name: 'transferIntroKal');
  }
  ...
  String get transferConfirmInfoKal {
    return Intl.message(
        "A wallet with a balance of %1 BANANO has been detected.\n",
        desc: 'transfer_confirm_info_first',
        name: 'transferConfirmInfoKal');
  }
  ...
  String get transferConfirmInfoKalThird {
    return Intl.message("Transfer may take several seconds to complete.",
        ...
        name: 'transferConfirmInfoKalThird');
  }
  ...
  String get transferCompleteKal {
    return Intl.message(
        "%1 BANANO successfully transferred to your Kalium Wallet.\n",
        desc: 'transfer_complete_text',
        name: 'transferCompleteKal');
  }
  ...
  String get exampleCardIntroKal {
    return Intl.message(
        "Welcome to Kalium. Once you receive BANANO, transactions will show up like this:",
  ...
  String getMonkeyDownloadUrl(String account,
      {int size = 1000, bool svg = false}) {
    if (svg) {
      return 'https://monkeys.appditto.com?address=$account';
    }
    return 'https://monkeys.appditto.com?address=$account&png=true&size=$size';
  }
