...
class SharedPrefsUtil {
  ...
  Future<void> setEncrypted(String key, String value) async {
    ...
    if (secret == null) {
      secret = Salsa20Encryptor.generateEncryptionSecret(16) +
          ":" +
          Salsa20Encryptor.generateEncryptionSecret(8);
  ...
  Future<AvailableBlockExplorer> getBlockExplorer() async {
    return AvailableBlockExplorer(AvailableBlockExplorerEnum.values[await get(
        cur_explorer,
        defaultValue: AvailableBlockExplorerEnum.CREEPER.index)]);
  }
  ...
  Future<ThemeSetting> getTheme() async {
    return ThemeSetting(ThemeOptions
        .values[await get(cur_theme, defaultValue: ThemeOptions.KALIUM.index)]);
  }
