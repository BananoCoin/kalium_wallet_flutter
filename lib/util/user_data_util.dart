  ...
  static Future<String> getQRData(DataType type, BuildContext context) async {
    ...
    try {
      ...
      if (e.code == BarcodeScanner.CameraAccessDenied) {
        sl.get<UIUtil>().showSnackbar(AppLocalization.of(context).qrInvalidPermissions, context);
        return QRScanErrs.PERMISSION_DENIED;
      } else {
        sl.get<UIUtil>().showSnackbar(AppLocalization.of(context).qrUnknownError, context);
